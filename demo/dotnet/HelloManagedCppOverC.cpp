/*----------------------------------------------------------------------------
Name:      HelloManagedCppOverC.cpp
Project:   xmlBlaster.org
Copyright: xmlBlaster.org, see xmlBlaster-LICENSE file
Author:    "Marcel Ruff" <xmlBlaster@marcelruff.info>
Note:      Example xmlBlaster access with a managed .net C++ client
-----------------------------------------------------------------------------*/
#include "stdafx.h"
#using <xmlBlasterClientCmanaged.dll>
...
/**
 * @example  HelloManagedCppOverC --help
 * @example  HelloManagedCppOverC.exe -dispatch/connection/plugin/socket/hostname myserverIP
 */
int main(array<System::String ^> ^args)
{
   ...
   try {
      Console::WriteLine(L"C++ xmlBlaster client using managed wrapper around C client DLL");
