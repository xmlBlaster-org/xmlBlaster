 ...
 * for usage help
 * <p />Example:
 * PublishDemo -oid __sys__remoteProperties -clientProperty.key "MultiByte" -clientProperty.value "With '�' multibyte" -clientProperty.charset windows-1252 -clientProperty.encoding base64
 */
