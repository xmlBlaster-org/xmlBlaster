 ...
 */
public class WebSocketCbConnection extends SocketExecutor
{
   private String ME = "SocketCbConnection";
   private Global glob;
   private static Logger log = Logger.getLogger(WebSocketCbConnection.class.getName());
    ...
    */
   public WebSocketCbConnection(Global glob) throws XmlBlasterException {
