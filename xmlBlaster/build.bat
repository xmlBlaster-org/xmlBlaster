...
set LOCALCLASSPATH=%JAVA_HOME%\lib\tools.jar;lib\ant\ant.jar;lib\ant\cpptasks.jar;lib\ant\ant-contrib.jar;lib\ant\xerces.jar;lib\ant\optional.jar;lib\junit.jar
