...
Version:   $Id: detail.xsl,v 1.14 2002/05/09 14:39:58 ruff Exp $
...
<xsl:template match="requirement">
   ...
   <!-- p class="sideend"> Last updated $Date: 2002/05/09 14:39:58 $ $Author: ruff $ </p -->
