...
Version:   $Id: ClientGet.java,v 1.5 1999/12/08 12:16:18 ruff Exp $
------------------------------------------------------------------------------*/
 ...
 * <p>
 * Invoke examples:
 *    ${JacORB_HOME}/bin/jaco testsuite.org.xmlBlaster.ClientGet -iorFile /tmp/NS_Ref
 *
 *    ${JacORB_HOME}/bin/jaco testsuite.org.xmlBlaster.ClientGet -name "Jeff" -iorFile /tmp/NS_Ref
 */
