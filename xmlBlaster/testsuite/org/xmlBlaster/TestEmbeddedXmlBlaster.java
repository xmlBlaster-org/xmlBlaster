 ...
 * Invoke examples:<br />
 * <pre>
 *    java junit.textui.TestRunner testsuite.org.xmlBlaster.TestEmbeddedXmlBlaster
 *    java junit.swingui.TestRunner testsuite.org.xmlBlaster.TestEmbeddedXmlBlaster
 * </pre>
...
public class TestEmbeddedXmlBlaster extends TestCase
{
   ...
   /**
    * Invoke: java testsuite.org.xmlBlaster.TestEmbeddedXmlBlaster
    * <p />
    * Note you need 'java' instead of 'java' to start the TestRunner, otherwise the JDK ORB is used
    * instead of the JacORB ORB, which won't work.
    * <br />
    * @deprecated Use the TestRunner from the testsuite to run it:<p />
    * <pre>   java -Djava.compiler= junit.textui.TestRunner testsuite.org.xmlBlaster.TestEmbeddedXmlBlaster</pre>
    */
