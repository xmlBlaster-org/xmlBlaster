...
public class ServerHelper {
   ...
   private String findPropertyFile(String fn) {
      ...
      if (f.canRead())
         return f.getPath();
      log.error(ME, "Can't locate property file " + fn + ". Please check your current directory or clustertest directory");
      throw new IllegalArgumentException("Can't locate property file " + fn + ". Please check your current directory or clustertest directory");
   }
