...
public class PublishFile
{
   ...
   public void publish(String xmlKey, byte[] content, String qos)
   {
      ...
      MessageUnit messageUnit = new MessageUnit(xmlKey, content);
      try {
   ...
   {
      Log.plain(ME, "----------------------------------------------------------");
      Log.plain(ME, "jaco org.xmlBlaster.client.filestore.PublishFile <options>");
      Log.plain(ME, "----------------------------------------------------------");
      ...
      Log.plain(ME, "jaco org.xmlBlaster.client.filestore.PublishFile -c Hello.xml");
      ...
      Log.plain(ME, "");
      Log.plain(ME, "jaco org.xmlBlaster.client.filestore.PublishFile -content \"Hello World\" -xmlKey \"<key oid='number12' contentMime='text/plain'></key>\"");
      Log.plain(ME, "----------------------------------------------------------");
      Log.plain(ME, "");
   }
   ...
   /**
    * Invoke:  jaco org.xmlBlaster.client.filestore.PublishFile -c <content-file> -k <key-file> -q <qos-file> -m <mime-type>
    */
