 ...
 */
public class LdbcConnectionPool implements I_Timeout, I_StorageProblemNotifier {
   private static String ME = "LdbcConnectionPool";
   ...
   */
   ...
   public synchronized void initialize(Global glob, Properties pluginProperties)
      ...
      // these should be handled by the LdbcManager
      ...
      ME = "LdbcConnectionPool-" + this.url;
...
//                " is wrong: no equality sign between key and value");
    ...
    * LdbcQueuePlugin and the values are the real names to be used in the database used (which may be vendor specific).
    */
...
//      this.initialized = false;
   ...
   synchronized public void registerManager(LdbcManagerCommonTable manager) {
   ...
   synchronized public void unregisterManager(LdbcManagerCommonTable manager) {
