...
public class LdbcPreparedQuery {
   public final static String ME = "LdbcPreparedQuery";
   private LogChannel log;
   public Connection conn;
   //private PreparedStatement st; Changed 2003-06-09 marcel for MS SQL server (thanks to zhang zhi wei)
   private Statement st;
   public ResultSet rs;
   private LdbcConnectionPool pool;
    ...
    * @param pool The LdbcConnectionPool to use for this prepared quuery
    * @param request the string to use as the request 
    * @param isAutoCommit
    * @param log
    * @param fetchSize
    */
   public LdbcPreparedQuery(LdbcConnectionPool pool, String request, boolean isAutoCommit, LogChannel log, int fetchSize)
...
//         if (fetchSize > -1) this.st.setFetchSize(fetchSize);
   ...
   public LdbcPreparedQuery(LdbcConnectionPool pool, String request, LogChannel log, int fetchSize)
      throws SQLException, XmlBlasterException {
