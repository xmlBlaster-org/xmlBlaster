...
public abstract class AddressBase
{
   ...
   public final String usage()
   {
    ...
    //text += "   -queue.onFailure    Error handling when connection failed (after all retries etc.) [" + CbQueueProperty.DEFAULT_onFailure + "].\n";
      text += "   -dispatch/clientSide/burstMode/collectTimeOneway   Number of milliseconds we shall collect oneway\n";
    ...
    //text += "   -compress.minSize   Messages bigger this size in bytes are compressed [" + Address.DEFAULT_minSize + "]\n";
      ...
      text += "   -dispatch/callback/sessionId       The session ID which is passed to our callback server\n";
      text += "                                      update() method.\n";
      text += "   -dispatch/callback/burstMode/collectTime  Number of milliseconds xmlBlaster shall collect\n";
      ...
      text += "   -dispatch/callback/oneway          Shall the update() messages be send oneway (no\n";
      ...
      text += "   -dispatch/callback/retries         How often to retry if callback fails (-1 forever, 0 no retry, > 0\n";
