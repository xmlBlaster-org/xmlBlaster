 ...
 *
 * $Id: ClientTable.java,v 1.1 2002/07/05 06:56:00 ruff Exp $
 */
...
public class ClientTable extends AgentXTable
{
    ...
    public AgentXVarBind getVarBind(AgentXEntry entry, long column)
    {
        ...
        case 5: // clientQueueNumMsgs
        {
            long value = ((ClientEntry)entry).get_clientQueueNumMsgs();
            return new AgentXVarBind(oid, AgentXVarBind.GAUGE32, value);
        }
        case 6: // clientQueueMaxMsgs
        {
            long value = ((ClientEntry)entry).get_clientQueueMaxMsgs();
            return new AgentXVarBind(oid, AgentXVarBind.GAUGE32, value);
        }
                        ...
                        AgentXVarBind vb)
    {
        ...
        case 6: // clientQueueMaxMsgs
        {
            if (vb.getType() != AgentXVarBind.GAUGE32)
                ...
                return ((ClientEntry)entry).set_clientQueueMaxMsgs(phase, vb.longValue());
        }
        case 7: // clientQueueThreshold
        {
            if (vb.getType() != AgentXVarBind.GAUGE32)
