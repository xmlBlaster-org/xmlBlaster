 ...
 *
 * $Id: SessionTable.java,v 1.1 2002/07/05 06:56:00 ruff Exp $
 */
...
public class SessionTable extends AgentXTable
{
    ...
    public AgentXVarBind getVarBind(AgentXEntry entry, long column)
    {
        ...
        case 3: // cbQueueNumMsgs
        {
            long value = ((SessionEntry)entry).get_cbQueueNumMsgs();
            return new AgentXVarBind(oid, AgentXVarBind.GAUGE32, value);
        }
        case 4: // cbQueueMaxMsgs
        {
            long value = ((SessionEntry)entry).get_cbQueueMaxMsgs();
            return new AgentXVarBind(oid, AgentXVarBind.GAUGE32, value);
        }
                        ...
                        AgentXVarBind vb)
    {
        ...
        case 4: // cbQueueMaxMsgs
        {
            if (vb.getType() != AgentXVarBind.GAUGE32)
                ...
                return ((SessionEntry)entry).set_cbQueueMaxMsgs(phase, vb.longValue());
        }
        case 5: // cbQueueThreshold
        {
            if (vb.getType() != AgentXVarBind.GAUGE32)
