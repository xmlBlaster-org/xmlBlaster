...
Version:   $Id: UnSubscribeQoS.java,v 1.3 1999/12/16 09:29:23 ruff Exp $
------------------------------------------------------------------------------*/
...
{
   private static String ME = "UnSubscribeQoS";
   ...
   {
      if (Log.CALLS) Log.calls(ME, "Creating UnSubscribeQoS(" + xmlQoS_literal + ")");
      init(xmlQoS_literal);
   }
