...
Version:   $Id: FileDriver.java,v 1.1 2000/06/25 18:26:47 ruff Exp $
...
public class FileDriver implements I_PersistenceDriver
{
   ...
   public final void recover(String oid, ClientInfo clientInfo, RequestBroker requestBroker) throws XmlBlasterException
   {
      try {
         ...
         MessageUnit msgUnit = new MessageUnit(xmlKey_literal, content, xmlQos_literal);

         PublishQoS publishQos = new PublishQoS(xmlQos_literal, true); // you need true here!
         XmlKey xmlKey = new XmlKey(xmlKey_literal, true); // you need true here!

         requestBroker.publish(clientInfo, xmlKey, msgUnit, publishQos);
