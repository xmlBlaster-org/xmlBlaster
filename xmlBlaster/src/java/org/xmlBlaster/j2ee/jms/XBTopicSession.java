...
public class XBTopicSession implements TopicSession {
   ...
   public TopicSubscriber createSubscriber(Topic topic) throws JMSException {
      return new XBTopicSubscriber(this.connection.getAccess(), topic, null, false);
   }
   ...
   public TopicSubscriber createSubscriber(Topic topic, String messageSelector, boolean noLocal)
      throws JMSException {
      return new XBTopicSubscriber(this.connection.getAccess(), topic, messageSelector, noLocal);
   }
