...
void XmlBlasterAccess::usage()
{
   ...
   text += string("   -dispatch/clientSide/protocol    Specify a protocol to talk with xmlBlaster, 'SOCKET' or 'IOR' or 'RMI' or 'SOAP' or 'XMLRPC'.\n");
   ...
   text += string("                       Example: java MyApp -dispatch/clientSide/protocol RMI -dispatch/clientside/protocol/rmi/hostname 192.168.10.34\n");
   text += string("\n");
