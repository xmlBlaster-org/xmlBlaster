...
void usage()
{
   fprintf(stderr,
    ...
    "Example:\n"
    "   client -xmlrpc.serverUrl http://anotherHost:8080/ -xmlrpc.cbUrl http://myHost:8080/RPC2 -name ben -passwd secret -dest gesa -msgFile xy.xml\n"
    "--------------------------------------------------\n");
}
