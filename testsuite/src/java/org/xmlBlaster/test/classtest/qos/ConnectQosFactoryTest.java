...
public class ConnectQosFactoryTest extends TestCase {
   private String ME = "ConnectQosFactoryTest";
   protected final Global glob;
   private static Logger log = Logger.getLogger(ConnectQosFactoryTest.class.getName());
   private String currImpl;
   private I_ConnectQosFactory factory;
   static I_ConnectQosFactory[] IMPL = { 
                   new org.xmlBlaster.util.qos.ConnectQosSaxFactory(Global.instance())
                 };
   ...
   public void testDefault() {
      ...
      /*
      try {
         ConnectQosData qos = factory.readObject((String)null);
         //assertEquals("", Constants.STATE_OK, qos.getState()); TODO
      }
      catch (XmlBlasterException e) {
   ...
   public void testPerformance() {
      ...
      System.out.println("***ConnectQosFactoryTest: testPerformance [SUCCESS]");
      */
   }
   ...
   public static void main(String args[]) {
      ...
      for (int i=0; i<IMPL.length; i++) {
         ConnectQosFactoryTest testSub = new ConnectQosFactoryTest(glob, "ConnectQosFactoryTest", i);
         testSub.setUp();
         testSub.testDefault();
         testSub.testParse();
